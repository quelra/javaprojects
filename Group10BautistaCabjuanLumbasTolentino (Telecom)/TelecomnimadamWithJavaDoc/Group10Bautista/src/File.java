/**
 * This class is the file for the user's information input and other information for billing charges.
 */
...
public class File {
    ...
    /**
     *The file for the program to be read that contains the accounts information for a new account
     *
    ...
    /**
     *This shows the user the billing information according to plan as well as the number of accounts
     *
     * @throws Exception when the method gets called
     *
     */
    ...
    /**
     *This sorts the data by the plan only
     *
     * @throws Exception when the method gets called
     *
     */
    ...
    /**
     *This enables the user to input the filename for the input file for the charges to be calculated.
     * This generates the phone number and add details for the account that is unique to an account.
     *
     * @throws Exception when the method gets called
     *
     */
    ...
    /**
     *Reads the information in the text file so that it will be read in the program
     *
     * @param a initialize the count
    ...
    /**
     * This gets the size of the charges file
     *
     * @param chargesFile the file of the charges
    ...
    /**
     *This gets the billing information to for the user from the respective plan charges
     *
     * @param Plan the plan of the account to be chosen.
     * @param Balance calculate the balance of the customer
     * @param SMS the limit of texts for the account
     * @param Calls the limit of calls for the account  in minutes
     * @param Data the limit of data for the account
